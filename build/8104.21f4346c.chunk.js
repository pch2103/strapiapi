...
`,ke=({childrenForm:e=[],isFormDisabled:t,recursiveLevel:o,pathToDataFromActionRow:n,propertyActions:r,parentName:a,propertyName:c})=>{const{formatMessage:i}=(0,B.c)(),{modifiedData:l,onChangeParentCheckbox:d,onChangeSimpleCheckbox:u}=Z(),[g,C]=j.useState(null),x=h=>{C(m=>m===h?null:h)},_=(0,j.useMemo)(()=>g?e.find(({value:h})=>h===g):null,[g,e]);return(0,s.jsxs)(y.k,{paddingLeft:"2rem",children:[(0,s.jsx)(hs,{}),e.map(({label:h,value:m,required:O,children:P},L)=>{const E=L+1<e.length,M=Array.isArray(P),T=g===m;return(0,s.jsxs)(ps,{isVisible:E,children:[(0,s.jsxs)(f.C,{height:ie,children:[(0,s.jsx)(gs,{children:(0,s.jsx)(Cs,{width:"20",height:"23",viewBox:"0 0 20 23",fill:"none",xmlns:"http://www.w3.org/2000/svg",color:"primary200",children:(0,s.jsx)("path",{fillRule:"evenodd",clipRule:"evenodd",d:"M7.02477 14.7513C8.65865 17.0594 11.6046 18.6059 17.5596 18.8856C18.6836 18.9384 19.5976 19.8435 19.5976 20.9688V20.9688C19.5976 22.0941 18.6841 23.0125 17.5599 22.9643C10.9409 22.6805 6.454 20.9387 3.75496 17.1258C0.937988 13.1464 0.486328 7.39309 0.486328 0.593262H4.50974C4.50974 7.54693 5.06394 11.9813 7.02477 14.7513Z",fill:"#D9D8FF"})})}),(0,s.jsxs)(f.C,{style:{flex:1},children:[(0,s.jsx)(us,{level:o,isActive:T,isCollapsable:M,children:(0,s.jsxs)(De,{alignItems:"center",isCollapsable:M,...M&&{onClick:()=>x(m),"aria-expanded":T,onKeyDown:({key:v})=>(v==="Enter"||v===" ")&&x(m),tabIndex:0,role:"button"},title:h,children:[(0,s.jsx)(b.O,{ellipsis:!0,children:re(h)}),O&&(0,s.jsx)($e,{}),(0,s.jsx)(ee,{$isActive:T})]})}),(0,s.jsx)(f.C,{style:{flex:1},children:r.map(({actionId:v,label:I,isActionRelatedToCurrentProperty:W})=>{if(!W)return(0,s.jsx)(Ce,{},v);const k=[...n.split(".."),v,"properties",c,...a.split(".."),m],z=A(l,k,!1);if(!P)return(0,s.jsx)(f.C,{position:"relative",width:G,justifyContent:"center",alignItems:"center",children:(0,s.jsx)(D.c,{disabled:t,name:k.join(".."),"aria-label":i({id:"Settings.permissions.select-by-permission",defaultMessage:"Select {label} permission"},{label:`${a} ${h} ${I}`}),onValueChange:U=>{u({target:{name:k.join(".."),value:U}})},value:z})},I);const{hasAllActionsSelected:F,hasSomeActionsSelected:te}=Y(z);return(0,s.jsx)(f.C,{position:"relative",width:G,justifyContent:"center",alignItems:"center",children:(0,s.jsx)(D.c,{disabled:t,name:k.join(".."),"aria-label":i({id:"Settings.permissions.select-by-permission",defaultMessage:"Select {label} permission"},{label:`${a} ${h} ${I}`}),onValueChange:U=>{d({target:{name:k.join(".."),value:U}})},value:F,indeterminate:te},I)},I)})})]})]}),_&&T&&(0,s.jsx)(y.k,{paddingBottom:2,children:(0,s.jsx)(ke,{isFormDisabled:t,parentName:`${a}..${m}`,pathToDataFromActionRow:n,propertyActions:r,propertyName:c,recursiveLevel:o+1,childrenForm:_.children})})]},m)})]})},ps=(0,S.cp)(y.k)`
...
`,fs=({onClick:e,className:t,hasConditions:o=!1,variant:n="tertiary"})=>{const{formatMessage:r}=(0,B.c)();return(0,s.jsx)(xs,{hasConditions:o,className:t,children:(0,s.jsx)(R.Z,{variant:n,startIcon:(0,s.jsx)(Je.c,{}),onClick:e,children:r({id:"global.settings",defaultMessage:"Settings"})})})},xs=(0,S.cp)(y.k)`
...
`,Ps=S.cp.div`
  ...
  ${({isActive:e,theme:t})=>e&&me(t,e)}
  &:hover {
    ${({theme:e,isActive:t})=>me(e,t)}
  }
`,Be=(0,S.cp)(f.C)`
  width: ${G};
  position: relative;
...
`,Ls=S.cp.div`
  ...
  `}
`,ks=[{labelId:"app.components.LeftMenuLinkContainer.collectionTypes",defaultMessage:"Collection Types",id:"collectionTypes"},{labelId:"app.components.LeftMenuLinkContainer.singleTypes",id:"singleTypes",defaultMessage:"Single Types"},{labelId:"app.components.LeftMenuLinkContainer.plugins",defaultMessage:"Plugins",id:"plugins"},{labelId:"app.components.LeftMenuLinkContainer.settings",defaultMessage:"Settings",id:"settings"}],Rs=j.forwardRef(({layout:e,isFormDisabled:t,permissions:o=[]},n)=>{const[{initialData:r,layouts:a,modifiedData:c},i]=j.useReducer(Bs,Is,()=>Ws(e,o)),{formatMessage:l}=(0,B.c)();j.useImperativeHandle(n,()=>({getPermissions(){const _=(0,_e.o1)(r.collectionTypes,c.collectionTypes),h=(0,_e.o1)(r.singleTypes,c.singleTypes),m={..._,...h};let O;return Q(m)?O=!1:O=Object.values(m).some((P={})=>Object.values(P).some(L=>ne(L,"conditions"))),{permissionsToSend:is(c),didUpdateConditions:O}},resetForm(){i({type:"RESET_FORM"})},setFormAfterSubmit(){i({type:"SET_FORM_AFTER_SUBMIT"})}}));const d=(_,h,m,O)=>{i({type:"ON_CHANGE_COLLECTION_TYPE_ROW_LEFT_CHECKBOX",pathToCollectionType:_,propertyName:h,rowName:m,value:O})},u=(_,h,m)=>{i({type:"ON_CHANGE_COLLECTION_TYPE_GLOBAL_ACTION_CHECKBOX",collectionTypeKind:_,actionId:h,value:m})},g=_=>{i({type:"ON_CHANGE_CONDITIONS",conditions:_})},C=j.useCallback(({target:{name:_,value:h}})=>{i({type:"ON_CHANGE_SIMPLE_CHECKBOX",keys:_,value:h})},[]),x=j.useCallback(({target:{name:_,value:h}})=>{i({type:"ON_CHANGE_TOGGLE_PARENT_CHECKBOX",keys:_,value:h})},[]);return(0,s.jsx)(ns,{availableConditions:e.conditions,modifiedData:c,onChangeConditions:g,onChangeSimpleCheckbox:C,onChangeParentCheckbox:x,onChangeCollectionTypeLeftActionRowCheckbox:d,onChangeCollectionTypeGlobalActionCheckbox:u,children:(0,s.jsxs)(Xe.M,{id:"tabs",label:l({id:"Settings.permissions.users.tabs.label",defaultMessage:"Tabs Permissions"}),children:[(0,s.jsx)(xe.k,{children:ks.map(_=>(0,s.jsx)(xe.s,{children:l({id:_.labelId,defaultMessage:_.defaultMessage})},_.id))}),(0,s.jsxs)(J.o,{style:{position:"relative"},children:[(0,s.jsx)(J.G,{children:(0,s.jsx)(Ke,{layout:a.collectionTypes,kind:"collectionTypes",isFormDisabled:t})}),(0,s.jsx)(J.G,{children:(0,s.jsx)(Ke,{layout:a.singleTypes,kind:"singleTypes",isFormDisabled:t})}),(0,s.jsx)(J.G,{children:(0,s.jsx)(Ue,{layout:a.plugins,kind:"plugins",isFormDisabled:t})}),(0,s.jsx)(J.G,{children:(0,s.jsx)(Ue,{layout:a.settings,kind:"settings",isFormDisabled:t})})]})]})})}),Is={initialData:{},modifiedData:{},layouts:{}},Bs=(e,t)=>(0,je.cp)(e,o=>{switch(t.type){case"ON_CHANGE_COLLECTION_TYPE_GLOBAL_ACTION_CHECKBOX":{const{collectionTypeKind:n,actionId:r,value:a}=t,c=["modifiedData",n];Object.keys(A(e,c)).forEach(i=>{const l=A(e,[...c,i,r],void 0);if(l){let d=q(l,a);if(!a&&d.conditions){const u=q(d.conditions,!1);d={...d,conditions:u}}V(o,[...c,i,r],d)}});break}case"ON_CHANGE_COLLECTION_TYPE_ROW_LEFT_CHECKBOX":{const{pathToCollectionType:n,propertyName:r,rowName:a,value:c}=t;let i=de(e.modifiedData);const l=n.split(".."),d=A(i,l,{});Object.keys(d).forEach(u=>{if(ne(d[u],`properties.${r}`)){const g=A(d,[u,"properties",r,a]),C=[...l,u,"properties",r,a];if(!(0,H.F)(g))V(i,C,c);else{const x=q(g,c);V(i,C,x)}}}),c||(i=oe(i)),V(o,"modifiedData",i);break}case"ON_CHANGE_CONDITIONS":{Object.entries(t.conditions).forEach(n=>{const[r,a]=n;V(o,["modifiedData",...r.split(".."),"conditions"],a)});break}case"ON_CHANGE_SIMPLE_CHECKBOX":{let n=de(e.modifiedData);V(n,[...t.keys.split("..")],t.value),t.value||(n=oe(n)),V(o,"modifiedData",n);break}case"ON_CHANGE_TOGGLE_PARENT_CHECKBOX":{const{keys:n,value:r}=t,a=[...n.split("..")];let c=de(e.modifiedData);const i=A(c,a,{}),l=q(i,r);V(c,a,l),r||(c=oe(c)),V(o,["modifiedData"],c);break}case"RESET_FORM":{o.modifiedData=e.initialData;break}case"SET_FORM_AFTER_SUBMIT":{o.initialData=e.modifiedData;break}default:return o}}),Ws=(e,t)=>{const{conditions:o,sections:{collectionTypes:n,singleTypes:r,plugins:a,settings:c}}=e,i={collectionTypes:n,singleTypes:r,plugins:Se(a,"plugin"),settings:Se(c,"category")},l={collectionTypes:Te(n,o,t),singleTypes:Te(r,o,t),plugins:ve(i.plugins,o,t),settings:ve(i.settings,o,t)};return{initialData:l,modifiedData:l,layouts:i}}},32912:(N,w,p)=>{"use strict";p.d(w,{U:()=>y});var s=p(19968),j=p(69372),f=p(5928);const y=({options:b,...R})=>(0,s.jsx)(f.e,{...R,children:b.map($=>"children"in $?(0,s.jsx)(f.OK,{label:$.label,values:$.children.map(K=>K.value.toString()),children:$.children.map(K=>(0,s.jsx)(D,{value:K.value,children:K.label},K.value))},$.label):(0,s.jsx)(f.eI,{value:$.value,children:$.label},$.value))}),D=(0,j.cp)(f.eI)`
